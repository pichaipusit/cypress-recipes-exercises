...
// TODO: Give them describe and context
describe(" ", function() {
  context(" ", function() {
    beforeEach(function() {
    ...
    it.only("solution #3: verify visibility prior to showing element", function() {
      // We can improve on solution #2 above by adding some tests
      // around the elements visibility.
      //
      // TODO: We check that the element is in the correct
    ...
    describe("if your app does not use jQuery", function() {
      ["mouseover", "mouseout", "mouseenter", "mouseleave"].forEach((event) => {
        it(`dispatches event: '${event}`, () => {
          ...
          // TODO: How to simulate the mouse events?
        });
      });
    });
  });
